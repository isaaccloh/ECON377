...
## ================= PROBLEMS (your turn) =========================
pct_chg <- (25-20)/(20*100)     # (a) percent change from $20 to $25   (hint: (25-20)/20*100) (25%)
## (b) an interest rate 3% -> 5%: percentage-POINT change = 2 p.p. ; percent change = (5-3)/(3*100) = 66.67% (comment)
